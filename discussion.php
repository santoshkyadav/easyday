...
<div class="row">
<div class="col-sm-12 parent"  style="padding:40px;background:#e1e1e1;color:black;">
<div class="col-sm-2">
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Discussion Form</i></li>
</ol>
<form action="discussioncode.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Put Your Question</label>
    <input type="text" class="form-control"  placeholder="Enter Question" name="discussion">
  </div>
  
  
  
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Post Question</button>
...
<ol class="breadcrumb" style="background:#e1e1e1;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Show Result</i></li>
</ol>
<form action="discussioncode.php" method="post">
  <div class="form-group">
    <table border="1" align="center" width="100%">
	<tr>
	<th style="text-align:center;font-family:cursor;font-size:18px;">Question_id</th>
	<th style="text-align:center;font-family:cursor;font-size:18px;">Question</th>
	<th style="text-align:center;font-family:cursor;font-size:18px;">Asked By</th>
	<th style="text-align:center;font-family:cursor;font-size:18px;">Date</th>
	<th style="text-align:center;font-size:18px;font-family:cursor;"> Post Answer</th>
<th style="text-align:center;font-size:18px;font-family:cursor;"> View Answer</th>
	</tr>
	<?php 
	$a=1;
	while($row=mysql_fetch_array($res1,MYSQL_BOTH))
	{
		?>
		<tr>
		<td style="text-align:center;font-family:cursor;font-size:18px;"><?php echo $a;?></td>
		<td style="text-align:center;font-family:cursor;font-size:18px;"><?php echo $row['question'];?></td>
		<td style="text-align:center;font-family:cursor;font-size:18px;"><?php echo $row['asked_by'];?></td>
		<td style="text-align:center;font-family:cursor;font-size:18px;"><?php echo $row['date'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><a href="reply.php?id=<?php echo $row['question_id'];?>" style="text-decoration:none;">Post Answer</a></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><a href="viewanswer.php?id=<?php echo $row['question_id']; ?>" style="text-decoration:none;">View Answer</a></td>	
</tr>	
		</tr>
