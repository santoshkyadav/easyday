...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Please Give Correct Answer </i></li>
</ol>
<form action="replycode.php?id=<?php echo $row['question_id'];?>" method="post">
<div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Your Question</label>
	<br/>
   
   <span style="font-size:18px;font-family:cursor;"><?php echo $a;?></span>
   <span style="font-size:18px;font-family:cursor;"><?php echo $row['question'];?></span>
 
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Put Your Answer</label>
    <input type="text" class="form-control"  placeholder="Enter Question" name="answer">
  </div>
  
  
  
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Post Answer</button>
