...
<p ><h3 style="text-align:center;margin-top:5px;color:#404040;font-family:cursor;"><i>Welcome To Contact Us</i></h3></p>
</div>
</div>
<!-- end of  heading-->

<div class="row" style="padding-top:20px;">
<div class="col-sm-12 parent"  style="padding:0px;background:#e1e1e1;padding-top:20px;">
...
<ol class="breadcrumb" style="background:#e1e1e1;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Contact Us</i></li>
</ol>
<form action="contactuscode.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Name</label>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Mobile No</label>
    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Mobile No" name="mobile">
  </div>
  <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Message</label>

  <textarea name="text" class="form-control">
  </textarea>
  
  <button type="submit" class="btn btn-default navbar-btn btn-block btn-lg" value="submit" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Submit</button>
