...
<h3 style="text-align:center;"><a href="#" style="text-decoration:none;color:#404040;font-family:cursor;"><i>Cart()</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="text-decoration:none;color:#404040;font-family:cursor;"><i>Orders</i></a></h3>
</div>
...
<form action="changepasswordcode.php" method="post">
  ...
  <button type="submit" class="btn btn-default navbar-btn btn-block btn-lg" value="submit" style="color:white;font-family:cursor;font-size:20px;background:#7575ff;">Change Password</button>
