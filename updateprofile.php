...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Update Profile</i></li>
</ol>
<form action="updatecode.php" method="post">
  <div class="form-group">
    <label for="exampleInputName" style="font-size:18px;font-family:cursor;">Name</label>
    <input type="text" class="form-control"  name="name" value="<?php echo $row['name'];?>">
  </div>
  <div class="form-group">
    <label for="exampleInputFname" style="font-size:18px;font-family:cursor;">Father Name</label>
    <input type="text" class="form-control" name="fname" value="<?php echo $row['fname'];?>">
  </div>
  <div class="form-group"> 
    <label for="exampleInputGender" style="font-size:18px;font-family:cursor;">Gender</label>
...
?> checked <?php }?> />Female
  ...
  <div class="form-group">
    <label for="exampleInputDOB" style="font-size:18px;font-family:cursor;">DOB</label>
    <input type="text" class="form-control" name="dob" value="<?php echo $row['dob'];?>">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Email</label>
    <input type="text" class="form-control" readonly name="email" value="<?php echo $row['email'];?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword" style="font-size:18px;font-family:cursor;">Password</label>
    <input type="text" class="form-control" readonly  name="password" value="<?php echo $row['password'];?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputAddress" style="font-size:18px;font-family:cursor;">Address</label>
    <textarea name="address" class="form-control" >
	<?php echo $row['address'];?>
    </textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputCity" style="font-size:18px;font-family:cursor;">City</label>
	...
	<option value="Ghorakhpur">Ghorakhpur</option>
    </select>
	
  </div>
   <div class="form-group">
    <label style="font-size:18px;font-family:cursor;">Pin No</label>
    <input type="number" class="form-control" name="pin" value="<?php echo $row['pin'];?>">
  </div>
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Update</button>
