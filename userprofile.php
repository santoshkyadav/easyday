...
?> 
   <div class="col-sm-3 col-md-3" style="padding-top:15px;">
    <div class="thumbnail">
      <img style="height:200px;" src="images/<?php echo $row['filename'];?>" alt="...">
      <div class="caption">
        
        <p style="text-align:center;"><a href="#" style="color:black;font-size:18px;font-family:cursor;"><?php echo $row['name'];?></a></p>
		<p style="text-align:center;"><a href="#" style="text-align:center;font-size:20px;color:black;">&#8377;<?php echo $row['after_discount_price'];?>      
		<Strike style="font-size:18px;"><?php 
		if($row['discount']==0)
		{
			$ssprice=0;
			
			?>
		<span style="display:none;"><?php echo $ssprice;?></span>
		...
		?>
		</strike></a><a href="#" style="text-align:center;font-size:20px;color:green;"> <?php echo $row['discount'];?>% off</a></p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cartcode.php?id=<?php echo $row['product_id'];?>" class="btn btn-primary" role="button">Add Cart</a> 
		<a href="#" class="btn btn-default" role="button" style="background:#ff4f4f;">Buy Now</a></p>
