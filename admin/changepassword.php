...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="discussion.php"><img src="../images/previous.png"/></a>
</div>
<div class="col-sm-8 panel panel-body hvr hvr-pulse" style="border:1px solid teal;font-size:18px;padding-top:10px;min-height:300px;background:#e1e1e1;">
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Change Password</i></li>
</ol>
<form action="changepasswordcode.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Enter Old Password</label>
    <input type="password" class="form-control" id="exampleInputEmail1" placeholder="Enter Old Password" name="op">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Enter New Password</label>
    <input type="password" class="form-control" id="exampleInputEmail1" placeholder="Enter New Password" name="np">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Confirm Password</label>
    <input type="password" class="form-control" id="exampleInputEmail1" placeholder="Confirm New Password" name="cnp">
  </div>
  
  
  <button type="submit" class="btn btn-default navbar-btn btn-block btn-lg" value="submit" style="color:black;font-family:cursor;font-size:20px;background:#e1e1e1;">Change Password</button>
