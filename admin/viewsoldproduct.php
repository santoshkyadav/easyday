...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="viewcart.php"><img src="../images/previous.png"/></a>
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Sold Product Details</i></li>
</ol>

</div>
<div class="col-sm-2">
<a href="addnotification.php"><img src="../images/next.png"/></a>
</div>
</div>
</div>
