...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="addcategory.php"><img src="../images/previous.png"/></a>
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Add Product</i></li>
</ol>
<form action="addproductcode.php" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Product Name</i></label>
    <input type="text" class="form-control"  placeholder="Product Name" name="pname">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Product Category</i> </label>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Cost Price</i></label>
    <input type="number" class="form-control"  placeholder="Enter Cost Price" name="cprice">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Selling Price</i></label>
    <input type="number" class="form-control"  placeholder="Enter S price" name="sprice">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Discount</i></label>
    <input type="number" class="form-control"  placeholder="Enter discount" name="discount">
  </div>
  
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Piecess</i></label>
    <input type="number" class="form-control"  placeholder="Enter S price" name="piecess">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Profile Pic</i></label>
    <input type="file" class="form-control"   name="file" >
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Description</i></label>
    <textarea name="description" class="form-control" >
	</textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;"><i>Expiry Date</i></label>
    <input type="date" class="form-control"   name="expirydate">
  </div>
  
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Add Product</button>
   
</form>
</div>
<div class="col-sm-2">
<a href="viewproduct.php"><img src="../images/next.png"/></a>
</div>
</div>
</div>
