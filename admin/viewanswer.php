...
$query1="select * from tbl_question INNER JOIN tbl_answer on tbl_question.question_id=tbl_answer.question_id";
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li><a href="addproduct.php">Add Product</a></li>
       <li><a href="viewproduct.php" >View Product</a></li>
		...
		<li><a href="viewcontactus.php">View Contact Us Details</a></li><li><a href="viewcart.php">View Cart</a></li>
...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="addnotification.php"><img src="../images/previous.png"/></a>
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Discussion Mgmt</i></li>
</ol>
<table border="1" align="center" width="100%">
<tr>
<th style="text-align:center;font-size:18px;font-family:cursor;">Sr. No</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Question</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Asked By</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Answer</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Posted By</th>
<th style="text-align:center;font-size:18px;font-family:cursor;"> Delete</th>
</tr>
<?php
$a=1;
...
?>	
<tr>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $a; ?></td>	
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['question']; ?></td>	
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['asked_by']; ?></td>

<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['answer']; ?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['posted_by']; ?></td>


<td style="text-align:center;font-size:18px;font-family:cursor;"><a href="#" style="text-decoration:none;">Delete</a></td>	
</tr>	
...
<div class="col-sm-2">
<a href="changepassword.php"><img src="../images/next.png"/></a>
</div>
</div>
</div>
