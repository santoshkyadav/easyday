...
<img src="../images/adminicon.png" height="80px" width="100%" style="padding-left:10px;"/>
</div>
</div>
<!--End Header-->
</div>
...
<div class="col-sm-12 panel panel-body hvr hvr-pulse" style="border:1px solid teal;font-size:15px;padding-top:10px;min-height:300px;background:#e1e1e1;">

<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;padding:0px;">

  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;color:#404040;"><i>All Users</i></li>
</ol>

<table border="1" width="100%">
<tr>
<th style="text-align:center;font-size:18px;font-family:cursor;">Register_Id</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Name</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Father Name</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Gender</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Date Of Birth</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Email</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Password</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Mobile</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Address</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">City</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Pin Code</th>
...
?>
<tr>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['register_id'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['name'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['fname'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['gender'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['dob'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['email'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['password'];?></td>
<td style="text-align:justify;font-size:18px;font-family:cursor;padding-left:10px;"><?php echo $row['mobile'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['address'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['city'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['pin'];?></td>
