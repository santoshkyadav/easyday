...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="addproduct.php"><img src="../images/previous.png"/>
</div>
<div class="col-sm-8 panel panel-body hvr hvr-pulse" style="border:1px solid teal;font-size:18px;min-height:300px;background:#e1e1e1;padding-top:10px;">
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;color:#404040;"><i>All Product</i></li>
</ol>
<table border="1" width="100%">
<tr>
<th style="text-align:center;font-size:18px;font-family:cursor;">Product_Id</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Catagory_id</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Product Name</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Cost Price</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Selling Price</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Piecess</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">File Name</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Description</th>
<th style="text-align:center;font-size:18px;font-family:cursor;">Expiry Date</th>
...
?>
<tr>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['product_id'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['category_id'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['name'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['cprice'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['sprice'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['piecess'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><img src="../images/<?php echo $row['filename'];?>" height="100px" width="100px"/></td>
<td style="text-align:justify;font-size:18px;font-family:cursor;padding-left:10px;"><?php echo $row['description'];?></td>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['expirydate'];?></td>
...
<div class="col-sm-2">
<a href="viewuser.php"><img src="../images/next.png"/>
</div>
