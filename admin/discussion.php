...
<tr>
<th style="text-align:center;font-size:18px;font-family:cursor;">Question_id</th>
...
?>	
<tr>
<td style="text-align:center;font-size:18px;font-family:cursor;"><?php echo $row['question_id']; ?></td>	
...
<td style="text-align:center;font-size:18px;font-family:cursor;"><a href="deleteanswer.php?id=<?php echo $row['question_id']; ?>" style="text-decoration:none;">Delete</a></td>	
</tr>	
