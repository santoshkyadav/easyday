...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="viewsoldproduct.php"><img src="../images/previous.png"/>
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;color:#404040;"><i>Add Notification</i></li>
</ol>
<form action="addnotificationcode.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;color:#404040;">Enter Notification</label>
  ...
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:white;font-family:cursor;font-size:20px;background:#e1e1e1;color:#404040;"><i>Add</i></button>
   
</form>
</div>
<div class="col-sm-2">
<a href="discussion.php"><img src="../images/next.png"/>
</div>
</div>
</div>
