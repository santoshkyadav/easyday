...
<div class="col-sm-12">
<div class="col-sm-2">
<a href="adminprofile.php"><img src="../images/previous.png"/></a>
</div>
...
<ol class="breadcrumb" style="background:#e1e1e1;border:1px solid;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Add Category</i></li>
</ol>
<form action="addcategorycode.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-size:18px;font-family:cursor;">Category Name</label>
    <input type="text" class="form-control"  placeholder="Category" name="category">
  </div>
  
  
  
  <button type="submit" class="btn btn-default navbar-btn btn-lg btn-block" style="color:white;font-family:cursor;font-size:20px;background:#e1e1e1;color:#404040;">Add</button>
   
</form>
</div>
<div class="col-sm-2">
<a href="addproduct.php"><img src="../images/next.png"/></a>
</div>
</div>
</div>
<!--show record-->
...
<ol class="breadcrumb" style="background:#e1e1e1;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Show Category</i></li>
</ol>
<table border="1" width="100%" height="30px" >
<tr >
<th style="text-align:center;text"><i>S .No</i></th>
<th style="text-align:center;"><i>Category Name</i></th>
<th style="text-align:center;"><i>Date</i></th>
<th style="text-align:center;"><i>Edit</i></th>
<th style="text-align:center;"><i>Delete</i></th>
</tr>
<?php
$a=1;
while($row=mysql_fetch_array($res1,MYSQL_BOTH))
{
	?>
<tr>
<td style="text-align:center;font-size:20px;"><?php echo $a; ?> </td>
<td style="text-align:center;font-size:20px;"><?php echo $row['categoryname']; ?> </td>
<td style="text-align:center;font-size:20px;"><?php echo $row['date']; ?> </td>
<td style="text-align:center;font-size:20px;"><a href="edit.php?id=<?php echo $row['category_id'];?>" style="text-decoration:none;color:#404040;">Edit</a></td>
<td style="text-align:center;font-size:20px;"><a href="delete.php?id=<?php echo $row['category_id']?>" style="text-decoration:none;color:#404040;">Delete</a></td>
