...
<!-- product heading-->
<div class="row">
<div class="col-sm-12" style="padding:0px;min-height:50px;background:#e1e1e1;border:1px solid;">
<p ><h3 style="text-align:center;margin-top:5px;color:#404040;font-family:cursor;">All Product</h3></p>
</div>
</div>
   ...
   <div class="col-sm-3 col-md-3" style="padding-top:15px;">
    <div class="thumbnail">
      ...
      <div class="caption">
		...
		<p style="text-align:center;"><a href="#" style="text-align:center;font-size:20px;color:black;">&#8377;<?php echo $row['cprice'];?>       <Strike style="font-size:18px;"><?php echo $row['sprice'];?></strike></a><a href="#" style="text-align:center;font-size:20px;color:green;"> 50% off</a></p>
        <p style="text-align:center;"><a href="login.php" class="btn btn-primary" role="button">Add Cart</a> 
...
<div class="col-sm-6">
<a href="#"><div class="fa fa-facebook" style="font-size:20px;"></div></a><br/>
