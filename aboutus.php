...
<p ><h3 style="text-align:center;margin-top:5px;color:#404040;font-family:cursor;"><i>About Easy Day</i></h3></p>
</div>
</div>
<!-- end of  heading-->
...
<ol class="breadcrumb" >
  <li style="font-size:18px;font-family:cursor;min-height:300px;text-align:justify;color:black;"><i>Easyday is an Indian retail brand that runs chains of consumer retail supermarkets and convenience stores. The brand is wholly owned by Future Retail Ltd. Bharti Enterprises announced its foray into retail in February 2007 and the first store was opened in Punjab in April 2008. Easyday presently has 523 stores across 12 states. 
Future Group, that owns and operate Big Bazaar, combined retail operations with Easyday in May 2015. The merger has created one of India's biggest retail chains with more than 890 stores in 246 cities in India.
