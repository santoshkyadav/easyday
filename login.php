...
<ol class="breadcrumb" style="background:#e1e1e1;">
  <li style="font-size:25px;font-family:cursor;min-height:50px;text-align:center;line-height:50px;padding-left:40%;"><i>Login Form</i></li>
</ol>
<form action="logincode.php" method="post">
  ...
  <button type="submit" class="btn btn-default navbar-btn btn-block btn-lg" style="color:#404040;font-family:cursor;font-size:20px;background:#e1e1e1;">Log In</button>
   <button type="submit" class="btn btn-default navbar-btn btn-block btn-lg" style="font-family:cursor;font-size:20px;">Forgot your password?</button>
  _________________________________________or___________________________________________
  <a href="register.php" style="text-decoration:none;"><button type="button" class="btn btn-default navbar-btn btn-block btn-lg" style="font-family:cursor;font-size:20px;">Create New Account</button></a>
